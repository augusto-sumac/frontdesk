  ...
  >
      ...
      <div class="hidden lg:block">
        <form>
          <div class="relative">
            ...
            <input
              type="text"
              placeholder="Buscar reservas, propriedades..."
              id="search-input"
    ...
    >
        ...
        >
          ...
          >
            ...
            <div class="text-center py-8">
              <i class="fas fa-bell-slash fa-3x text-gray-400 mb-3"></i>
              <h5 class="text-lg font-semibold text-gray-700 dark:text-gray-300">Nenhuma notificação</h5>
              <p class="text-gray-500 dark:text-gray-400">Você está em dia!</p>
            </div>
          </div>
          <!-- Dropdown End -->
        </div>
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full bg-gray-200 flex items-center justify-center">
            <i class="fas fa-user text-gray-600"></i>
          </span>

          <span class="text-theme-sm mr-1 block font-medium"> {{ Auth::user()->name ?? 'Usuário' }} </span>
